...
const MainFooter = () => {
    return (
        ...
        <section className='bg-[#0C2F20] font-poppins'>
            <div className='md:w-[85%] px-6   md:m-auto  md:grid md:grid-cols-4 md:gap-10 py-10 '>
                
                <div className=' '>
                <img  src="/public/logo-light.svg" alt="" />
               </div>

             <div className='text-primary md:mt-14 mt-6'>
             ...
             <div className='text-primary md:mt-14'>
                <h1 className='text-xl font-bold mt-12'>Office Address</h1>
               <span className='flex gap-2 mt-3'><GrLocation className='text-5xl' />
               <p>House-32, Road-01, Block-G, South Banasree, Dhaka</p></span> 
             </div>

             <div className='text-primary md:mt-14 mt-12'>
            ...
            <div className='md:w-[85%] m-auto px-10'>
                <img src="/public/sslcommerz-banner.png" alt="" />
            </div>
           <div className='md:w-[85%] m-auto mt-6'>
           <hr />
           </div>

           <div className='text-slate-400 md:w-[85%] mt-8  md:flex grid grid-cols-2   justify-between m-auto md:mb-0 md:mt-auto text-sm font-poppins md:py-6 px-6' >
            <h1 className=''>© 2025 Copyright | All Rights Reserved</h1>
            <h2 className='mb-8'>License: TRAD/DSCC/003127/2024</h2>
           </div>
