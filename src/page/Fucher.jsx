  ...
  return (
    <>
      <section className="bg-[#0C2F20] md:py-10 py-10 px-4">
        ...
        <div className=" flex flex-col-reverse items-center md:flex-row md:w-[90%] m-auto">

          <div className="bg-green-900py-2 p-10 rounded-md border text-primary items-center hover:text-black transition duration-500  border-green-700 hover:border-secondary">
            
            <IoHomeOutline className="text-6xl" />
           
            <h1 className=" text-4xl font-hind font-bold"> করা যাবে <br />ঘরে বসেই</h1>
          </div>
          <div className="bg-green-900py-2 p-10 rounded-md border text-primary items-center hover:text-black transition duration-500  border-green-700 hover:border-secondary">
